...
str.writeByteC(100);
	...
	public boolean inMulti() {
			...
			(absX >= 3456 && absX <= 3510 && absY >= 9480 && absY <= 9525) ||
			(absX >= 2455 && absX <= 2477 && absY >= 4763 && absY <= 4792) ||
			(absX >= 3082 && absX <= 3141 && absY >= 9669 && absY <= 9698) ||
			(absX >= 2850 && absX <= 2899 && absY >= 9757 && absY <= 9830) ||
			(absX >= 2849 && absX <= 2884 && absY >= 9911 && absY <= 9969) ||
(absX >= 2833 && absX <= 2875 && absY >= 9729 && absY <= 9767) ||
			(absX >= 2824 && absX <= 2944 && absY >= 5258 && absY <= 5400)
			) {
			return true;
		}
		return false;
